...
| test cases:.a large proportion of the issues related to handling failing cases.|2 |if a test case fails, open an issue and fix it (One of many examples: https://github.com/ineelshah/SRIJAS/issues/31)|
...
|  Project has an e-mail address or forum that is solely for supporting users |  3|  srijas.alerts@gmail.com |
